import type { BlogPost } from "../types/backend-types";
...
export const defaultBlogPosts: BlogPost[] = [
  {
    ...
    content: "",
    excerpt:
      "Learn how to create and stick to a monthly budget that works for your lifestyle and financial goals.",
  ...
  },
  {
    ...
    content: "",
    excerpt:
      "Essential steps to build a solid emergency fund and protect yourself from financial emergencies.",
