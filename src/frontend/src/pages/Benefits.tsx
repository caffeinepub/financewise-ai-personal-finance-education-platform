  ...
  const benefits = [
    {
      ...
      description:
        "Make better financial decisions with AI-powered insights and recommendations.",
    },
    {
      icon: Shield,
    ...
    },
    {
      ...
      title: "Save Time",
      description:
        "Automate expense tracking and get instant financial analysis.",
    },
    {
      icon: Heart,
      title: "Reduce Stress",
      description:
        "Feel confident about your finances with clear insights and goal tracking.",
    },
    {
      icon: Zap,
      title: "Achieve Goals Faster",
      description:
        "AI-powered predictions help you reach your financial goals sooner.",
    },
    {
      icon: CheckCircle2,
      title: "100% Free",
