          ...
          <Card>
            <CardContent className="p-8 prose prose-invert max-w-none">
              <p className="text-lg">
                ...
                Conditions") carefully before using the FinanceWise AI
                application (the "Service") operated by FinanceWise AI ("us",
                "we", or "our").
              </p>
              ...
              <p>
                ...
                FinanceWise AI and its licensors.
              </p>

              <h2>4. Links To Other Web Sites</h2>
              <p>
                Our Service may contain links to third-party web sites or
                services that are not owned or controlled by FinanceWise AI. We
              ...
              <p>
                In no event shall FinanceWise AI, nor its directors, employees,
              ...
              <p>
                ...
                implied. FinanceWise AI does not provide financial advice.
              </p>
