...
const assessmentQuestions: AssessmentQuestion[] = [
  {
    ...
    options: [
      {
        value: "a",
        label: "I must buy it immediately, even if I don't need it",
        score: 1,
      },
      {
        value: "b",
        label: "I consider if I actually need it before buying",
        score: 3,
      },
      {
        value: "c",
        label: "I rarely buy things on sale unless planned",
        score: 5,
      },
    ],
  },
  ...
  },
  {
    ...
    options: [
      ...
      {
        value: "b",
        label: "Comfortable with moderate, calculated risks",
        score: 3,
      },
      {
        value: "c",
        label: "Excited by high-risk, high-reward opportunities",
        score: 5,
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        value: "c",
        label: "Research extensively and compare options",
        score: 5,
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        value: "c",
        label: "I create a plan and tackle it systematically",
        score: 5,
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        value: "c",
        label: "I automate savings and invest regularly",
        score: 5,
      },
    ],
  },
...
function calculateAssessmentResult(
  ...
  if (percentage >= 80) {
    ...
    description =
      "You are highly disciplined with excellent financial habits. You plan ahead, track expenses meticulously, and make informed decisions.";
    traits = [
      {
        trait: "Financial Discipline",
        score: 92,
        description: "Excellent at sticking to budgets",
      },
      {
        trait: "Long-term Planning",
        score: 88,
        description: "Strong future orientation",
      },
      {
        trait: "Risk Management",
        score: 85,
        description: "Calculated risk-taker",
      },
      {
        trait: "Emotional Spending",
        score: 15,
        description: "Very low emotional purchases",
      },
    ];
    recommendations = [
    ...
    description =
      "You balance risk and security, making thoughtful financial decisions while staying open to opportunities.";
    traits = [
      {
        trait: "Financial Discipline",
        score: 78,
        description: "Good at sticking to budgets",
      },
      {
        trait: "Long-term Planning",
        score: 72,
        description: "Decent future orientation",
      },
      {
        trait: "Risk Management",
        score: 65,
        description: "Comfortable with moderate risk",
      },
      {
        trait: "Emotional Spending",
        score: 35,
        description: "Occasional emotional purchases",
      },
    ];
    recommendations = [
    ...
    description =
      "You are careful with money but could benefit from more structured financial planning and risk-taking.";
    traits = [
      {
        trait: "Financial Discipline",
        score: 55,
      ...
      },
      {
        trait: "Long-term Planning",
        score: 48,
        description: "Limited future planning",
      },
      { trait: "Risk Management", score: 42, description: "Risk-averse" },
      {
        trait: "Emotional Spending",
        score: 52,
        description: "Moderate emotional purchases",
      },
    ];
    recommendations = [
    ...
    description =
      "You tend to make spontaneous financial decisions. Building better habits and awareness will significantly improve your financial health.";
    traits = [
      {
        trait: "Financial Discipline",
        score: 32,
      ...
      },
      {
        trait: "Long-term Planning",
        score: 28,
        description: "Very limited planning",
      },
      {
        trait: "Risk Management",
        score: 25,
        description: "High unintentional risk",
      },
      {
        trait: "Emotional Spending",
        score: 75,
        description: "High emotional purchases",
      },
    ];
    recommendations = [
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            Self Awareness - Understand your financial behavior with real-time
            insights
          </p>
        </div>
          ...
          <>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="p-6 rounded-lg bg-card border-2 border-border/50">
                    ...
                    <p className="text-3xl font-bold text-chart-1">
                      {assessmentResult.riskTolerance}
                    </p>
                    <p className="text-sm text-muted-foreground mt-3">
            ...
            <Card className="border-2 border-border/50">
              <CardHeader>
                ...
                <CardDescription>
                  Your behavioral patterns and tendencies
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                {assessmentResult.traits.map((trait) => (
          ...
          <>
            ...
            <Card className="border-2 border-primary/20 bg-gradient-to-br from-primary/5 to-chart-1/5">
              <CardHeader>
                ...
                <CardDescription className="text-base">
                  Take our 8-question assessment to understand your money
                  mindset
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
              ...
              <Card className="border-2 border-chart-1/20 bg-gradient-to-br from-card to-chart-1/5">
                ...
                <CardContent>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm">
                        Learn how your psychology affects your financial
                        decisions
                      </p>
                    </div>
                  </div>
              ...
              <Card className="border-2 border-green-500/20 bg-gradient-to-br from-card to-green-500/5">
                ...
                <CardContent>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm">
                        Get personalized tips to build better financial habits
                      </p>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card className="border-2 border-primary/20 bg-gradient-to-br from-card to-primary/5">
                ...
                <CardContent>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm">
                        Retake the assessment to see how you've improved
                      </p>
                    </div>
                  </div>
                </CardContent>
