        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <Card className="border-2 border-primary/20">
            ...
            <CardContent className="space-y-4 text-muted-foreground">
              <p>
                By accessing and using FinanceWise AI, you agree to be bound by
          ...
          <Card className="border-2 border-border/50">
            ...
            <CardContent className="space-y-4 text-muted-foreground">
              <p>
                All content, features, and functionality of FinanceWise AI are
                owned by us and are protected by international copyright,
                trademark, and other intellectual property laws.
              </p>
              <p>
                You retain ownership of your financial data. By using our
                service, you grant us a license to process and analyze your data
          ...
          <Card className="border-2 border-border/50">
            ...
            <CardContent className="space-y-4 text-muted-foreground">
              <div>
                ...
                <p>
                  FinanceWise AI is provided for educational and informational
                  purposes only. It is not intended to provide financial,
              ...
              <div>
                ...
                <p>
                  AI-generated insights and recommendations are based on
                  algorithms and may not always be accurate. Always consult with
                  qualified financial professionals before making important
                  financial decisions.
                </p>
              </div>
              <div>
                ...
                <p>
                  We do not guarantee specific financial outcomes or results
                  from using our service. Past performance does not indicate
                  future results.
                </p>
              </div>
            </CardContent>
          ...
          <Card className="border-2 border-border/50">
            ...
            <CardContent className="space-y-4 text-muted-foreground">
              <p>
                To the maximum extent permitted by law, FinanceWise AI shall not
          ...
          <Card className="border-2 border-border/50">
            ...
            <CardContent className="space-y-4 text-muted-foreground">
              <p>
                ...
                100% uptime. We reserve the right to modify, suspend, or
          ...
          <Card className="border-2 border-border/50">
            ...
            <CardContent className="space-y-4 text-muted-foreground">
              ...
              <p>
                ...
                page. Upon termination, your data will be permanently deleted.
              </p>
            </CardContent>
          </Card>
