  ...
  const steps = [
    {
      ...
      description:
        "Sign up with Internet Identity for secure, password-free authentication",
      details: [
    ...
    },
    {
      ...
      description:
        "Input your transactions, income, expenses, and financial goals",
      details: [
    ...
    },
    {
      ...
      description:
        "Receive AI-powered recommendations tailored to your situation",
      details: [
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <p className="text-xl text-muted-foreground">
              A simple, step-by-step guide to mastering your finances with
                ...
                >
                  <CardHeader>
                    <div className="flex items-start gap-6">
                      <div
                        className={`w-16 h-16 rounded-full bg-gradient-to-r ${step.color} flex items-center justify-center text-white font-bold text-2xl shrink-0`}
                      >
                        {index + 1}
                      </div>
        ...
        <div className="container mx-auto px-4">
          <Card className="max-w-4xl mx-auto border-2 border-primary/20 bg-gradient-to-br from-primary/5 to-chart-1/5">
            <CardContent className="p-12 text-center space-y-6">
              ...
              <p className="text-xl text-muted-foreground">
                Join FinanceWise AI today and start your journey to financial
                freedom
              </p>
