        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <Card className="border-2 border-primary/20">
            ...
            <CardContent className="space-y-4 text-muted-foreground">
              <p>
                At FinanceWise AI, we take your privacy seriously. This Privacy
            ...
            <CardContent className="space-y-4 text-muted-foreground">
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 ml-4">
                  <li>
                    Name and email address (provided during profile setup)
                  </li>
          ...
          <Card className="border-2 border-border/50">
            ...
            <CardContent className="space-y-4 text-muted-foreground">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>
                  Internet Identity for secure, password-free authentication
                </li>
            ...
            <CardContent className="space-y-4 text-muted-foreground">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>
                  ...
                  (AdSense ID: ca-pub-5050836253831761)
                </li>
                <li>
                  <strong>Google Analytics:</strong> For understanding user
                  behavior (only with your consent)
                </li>
                <li>
                  <strong>Internet Computer:</strong> For blockchain-based data
                  storage and authentication
                </li>
              </ul>
              <p className="mt-4">
                These services have their own privacy policies. We do not share
                your financial data with any third parties.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 border-border/50">
            ...
            <CardContent className="space-y-4 text-muted-foreground">
              <p>
                ...
                experience. You can manage your cookie preferences through our
                Cookie Consent banner or in your browser settings. See our{" "}
                <a
                  href="/cookie-policy"
          ...
          <Card className="border-2 border-border/50">
            ...
            <CardContent className="space-y-4 text-muted-foreground">
              <p>
                FinanceWise AI is not intended for users under 18 years of age.
