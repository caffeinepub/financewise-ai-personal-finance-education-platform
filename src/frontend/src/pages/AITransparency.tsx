          ...
          <Card className="border-2 border-primary/20 bg-gradient-to-br from-primary/5 to-chart-1/5">
            <CardHeader>
              ...
              <CardDescription className="text-base">
                We use three complementary machine learning models to provide
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  Analyzes historical spending patterns to predict future
                  expenses and identify trends. Best for understanding long-term
                  financial behavior.
                </p>
              </div>
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  A neural network that captures short-term patterns and
                  seasonal variations in your spending. Excellent for monthly
                  budget predictions.
                </p>
              </div>
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  ...
                  Identifies subtle relationships between different financial
                  behaviors over time.
                </p>
              </div>
            </CardContent>
          ...
          <Card className="border-2 border-chart-3/20">
            ...
            <CardContent>
              <p className="text-muted-foreground mb-4">
                Your data is used exclusively to generate your personal
                insights. We never:
              </p>
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
