  ...
  const resourceCategories = [
    {
      ...
      description:
        "Comprehensive guides on budgeting, saving, investing, and financial planning",
      items: [
    ...
    },
    {
      ...
      description:
        "Step-by-step video lessons on using FinanceWise AI and financial concepts",
      items: [
    ...
    },
    {
      ...
      description:
        "Interactive tools for SIP, EMI, FIRE, tax planning, and investment calculations",
      items: [
        "SIP Calculator",
        "EMI Calculator",
        "FIRE Calculator",
    ...
    },
    {
      ...
      description:
        "Structured courses on personal finance, investing, and wealth building",
      items: [
    ...
    },
    {
      ...
      description:
        "Downloadable templates for budgeting, goal tracking, and financial planning",
      items: [
    ...
    },
    {
      ...
      title: "Blog Articles",
      description:
        "In-depth articles on financial topics, market trends, and money management",
      items: [
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <p className="text-xl text-muted-foreground">
              Everything you need to master your finances—guides, calculators,
              videos, and more
            </p>
          </div>
        </div>
