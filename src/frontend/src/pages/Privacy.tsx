        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <Card>
            <CardContent className="p-8 prose prose-invert max-w-none">
              <p className="text-lg">
                Welcome to FinanceWise AI. We are committed to protecting your
              ...
              <p>
                ...
                to us, such as your name, email address, and financial data
                (income, expenses, goals). We also automatically collect certain
                information when you use our app, such as your IP address,
              ...
              <p>
                ...
                your experience, and to analyze usage patterns.
              </p>
              ...
              <p>
                ...
                providers who assist us in operating our application, conducting
              ...
              <p>
                ...
                securely in Firebase, and we use industry-standard encryption to
