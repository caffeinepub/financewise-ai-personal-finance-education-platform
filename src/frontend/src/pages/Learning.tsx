  ...
  const achievements = [
    {
      ...
      unlocked: (stats?.questionsCompleted || 0) >= 10,
    },
    {
      name: "Knowledge Seeker",
      description: "Complete 25 questions",
      unlocked: (stats?.questionsCompleted || 0) >= 25,
    },
    {
      name: "Finance Expert",
      description: "Complete 50 questions",
      unlocked: (stats?.questionsCompleted || 0) >= 50,
    },
    {
      name: "Perfect Score",
      description: "Get 10 correct in a row",
      unlocked: (stats?.correctAnswers || 0) >= 10,
    },
  ];
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        <div>
          ...
          <p className="text-muted-foreground">
            Test your financial knowledge with 100 educational questions
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {achievements.map((achievement) => (
              <Card
                ...
                className={
                  achievement.unlocked ? "border-primary" : "opacity-50"
                }
              >
                <CardHeader>
                  <div className="flex items-center gap-3">
                    <Trophy
                      className={`w-8 h-8 ${achievement.unlocked ? "text-primary" : "text-muted-foreground"}`}
                    />
                    <div>
