...
import { AlertCircle, ArrowLeft, BookOpen, Calendar } from "lucide-react";
...
function BlogContent({ html }: { html: string }) {
  ...
  return (
    <div
      ...
      // biome-ignore lint/security/noDangerouslySetInnerHtml: blog content is sanitized HTML from static data
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-amber-800 dark:text-amber-200">
                      This content is for educational purposes and general
                      guidance only. It is not personalized financial advice.
                      Always consult qualified financial advisors before making
