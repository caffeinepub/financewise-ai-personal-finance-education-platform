...
const CATEGORY_TEMPLATES: CategoryTemplate[] = [
  { name: "Rent / Housing", allocationType: "Needs", defaultShare: 0.4 },
  ...
  { name: "Shopping", allocationType: "Wants", defaultShare: 0.4 },
  { name: "Education", allocationType: "Wants", defaultShare: 0.25 },
  { name: "Emergency Fund", allocationType: "Savings", defaultShare: 0.5 },
  { name: "Investment", allocationType: "Savings", defaultShare: 0.5 },
];
