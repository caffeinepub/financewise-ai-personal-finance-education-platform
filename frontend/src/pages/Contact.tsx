          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Card>
                ...
                <CardContent><p className="text-sm text-muted-foreground">fwiseai@gmail.com</p></CardContent>
              </Card>
              <Card>
                <CardHeader>
                ...
                <CardContent><p className="text-sm text-muted-foreground">Within 24-48 hours</p></CardContent>
              </Card>
              <Card>
                <CardHeader>
                ...
                <CardContent><p className="text-sm text-muted-foreground">Available Mon-Fri</p></CardContent>
              </Card>
            </div>
            ...
            <Card>
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <Button type="submit" size="lg" className="w-full" disabled={submitForm.isPending}>
